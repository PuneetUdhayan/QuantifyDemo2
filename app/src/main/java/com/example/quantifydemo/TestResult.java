...
public class TestResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MarksAndAnswers marksAndAnswers=new MarksAndAnswers(testScore,Common.answerSheetList,Common.selectedTest.getSubject(),Common.selectedTest.getTeacher(),Common.questionList.size());

        userReference.setValue(marksAndAnswers);
